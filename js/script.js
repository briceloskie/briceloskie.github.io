...
const translations = {
    en: {
        ...
        "about.intro": "I am Xun Fu, a researcher specializing in data mining and artificial intelligence. My work focuses on developing active learning and semi-supervised learning algorithms, as well as neural network applications, and my research results have been published in various international conferences and journals. In future research, I am eager to explore the intersection of brain science and brain-computer interface technologies based on data mining and artificial intelligence.",
        "about.research_goal": "",
        "contact.email": "Email:",
        "contact.phone": "Phone:",
    ...
    zh: {
        ...
        "about.intro": "我是付勋，专注于数据挖掘和人工智能领域的研究者。我的工作重点是开发主动学习和半监督学习算法，以及神经网络应用，我的研究成果已在多个国际会议和期刊上发表。在未来的研究中，我渴望在数据挖掘和人工智能的基础上探索脑科学与脑机接口技术的交叉领域。",
        "about.research_goal": "",
        "contact.email": "邮箱:",
        "contact.phone": "电话:",
        "photos.group": "生活照片",
